...
contract xAquaToken is ERC20("Atlantis AQUA escrowed Token", "xAQUA") {
    using EnumerableSet for EnumerableSet.AddressSet;
    EnumerableSet.AddressSet private _minters;
    ERC20 private _linkedToken;

    constructor(ERC20 _mmf) public {
        _linkedToken = _mmf;
    }
    ...
    function mint(
        ...
        _linkedToken.mintTo(address(this), _amount);
        _mint(_to, _amount);
        return true;
    }

    function lock(uint256 _amount) public onlyMinter {
        require(_linkedToken.transferFrom(msg.sender, address(this), _amount));
        _mint(msg.sender, _amount);
    }

    function redeem(uint256 _amount) public onlyMinter {
        require(_linkedToken.transfer(msg.sender, _amount));
