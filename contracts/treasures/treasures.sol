    ...
    IDividendsV2
{
    ...
    IERC20 private xAQUA = IERC20(0x11ef47783740B3F0c9736D54BE8eF8953C3Ead99);
    ...
    function allocate(
        ...
        xAQUA.transferFrom(msg.sender, address(this), amount);
    ...
    function deallocate(
        ...
        xAQUA.transfer(msg.sender, amount);
