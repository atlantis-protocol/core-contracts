...
contract AtlantisPair is IPair, UniswapV2ERC20 {
    ...
    function setFeePercent(
        ...
        require(
            msg.sender == IFactory(factory).feePercentOwner(),
    ...
    function setStableSwap(
        ...
        require(
            msg.sender == IFactory(factory).setStableOwner(),
    ...
    function setPairTypeImmutable() external lock {
        require(
            msg.sender == IFactory(factory).owner(),
    ...
    function _swap(
...

        {
            ...
            uint referrerInputFeeShare = referrer != address(0)
                ? IFactory(factory).referrersFeeShare(referrer)
                : 0;
            ...
            if (stableSwap) {
                (uint ownerFeeShare, address feeTo) = IFactory(factory)
                    .feeInfo();
                if (feeTo != address(0)) {
